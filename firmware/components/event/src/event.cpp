...
std::string_view EventId::value() const noexcept { return value_; }
...
std::string_view EventType::value() const noexcept { return value_; }
...
std::string_view DeviceUid::value() const noexcept { return value_; }
...
Timestamp Event::occurred_at() const noexcept { return metadata_.occurred_at; }
